...
namespace eBelge_DataSyncHub.Func
{
    public class e_Ledger_Func
    {
        ...
        public e_Ledger_Func()
        {
            ...
            settingLedger = glb_Func.getProjectProperty(ProjectsEnum.eLedger);
        }
        ...
        public async Task getUpragateList()
        {
            try
            {
                htmlValueListsOut = await glb_Func.getHtmlValueList(ProjectsEnum.eLedger);
            }
            catch (Exception ex)
            {

                throw new Exception("eLedger getUpragateList İşlemler sırasında bir hata oluştu." + ex.Message);
            }
        }
        ...
        public async Task getCurrentList()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("eLedger getCurrentList İşlemler sırasında bir hata oluştu." + ex.Message);
            }
        }
        ...
        public async Task saveAndPushNotification()
        {
            try
            {
                ...
                if (!glb_Func.checkInternetConnection())
                    throw new Exception("eLedger saveAndPushNotification İnternet bağlantısı bulunamadı.");
            ...
            {
                throw new Exception("eLedger saveAndPushNotification İşlemler sırasında bir hata oluştu." + ex.Message);
            }
        }
        ...
        public async Task<bool> getListAndControl()
        {
            try
            {
                ...
                {
                    glb_Func.WriteLog("eLedger getListAndControl işleminde yeni duyuru bulundu. Firebase'e kaydedilip bildirim gönderilecek.", EventLogEntryType.Information);
                ...
                {
                    glb_Func.WriteLog("eLedger getListAndControl işleminde yeni duyuru bulunamadı.", EventLogEntryType.Information);
                    return false;
                }
            }
            catch (Exception ex)
            {
                throw new Exception("eLedger getListAndControl İşlemler sırasında bir hata oluştu." + ex.Message);
            }
        }
